...
export function BookingPage() {
  return (
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(340px,0.7fr)]">
      <BookingForm />
      <aside className="surface relative overflow-hidden p-6 md:p-8">
        ...
        <h2 className="relative mt-5 max-w-md text-3xl font-black leading-tight text-white">משיחה ראשונה לפגישה שנקבעה, בלי חיכוך.</h2>
        ...
        <div className="relative mt-10 flex items-center justify-between rounded-xl border border-white/[0.08] bg-black/20 p-4">
